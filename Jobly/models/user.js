...
class User {
  ...
  static async applyForJob(username, jobId) {
    ...
    // Insert a new application for the user to the job
    await db.query(
  ...
  /** Get all info on user, including jobs they have applied for */
  static async get(username) {
    const userRes = await db.query(
    ...
    user.jobs = jobsRes.rows.map(j => j.job_id);  // List of job IDs
